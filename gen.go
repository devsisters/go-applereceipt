...
}).Parse(`// Code generated by pkg/applereceipt/gen.go. DO NOT EDIT.
...
func main() {
	...
	// matches := fieldDefPattern.FindAllStringSubmatch(string(content), -1)
	...
	// 		continue
	// 	}
	// 	fmt.Println(title, desc, fieldType, fieldValue)
	// }
}
